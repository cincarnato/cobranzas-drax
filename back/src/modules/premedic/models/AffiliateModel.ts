...
import type {IAffiliate} from '../interfaces/IAffiliate'
...
const AffiliateModel = mongoose.model<IAffiliate, PaginateModel<IAffiliate>>(MODEL_NAME, AffiliateSchema,COLLECTION_NAME);
