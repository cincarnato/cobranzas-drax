...
import type {IBankMovement} from '../interfaces/IBankMovement'

const BankMovementSchema = new mongoose.Schema<IBankMovement>({
...
const BankMovementModel = mongoose.model<IBankMovement, PaginateModel<IBankMovement>>(MODEL_NAME, BankMovementSchema,COLLECTION_NAME);
