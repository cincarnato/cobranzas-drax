...
const InboundEmailSchema = new mongoose.Schema({
    ...
    customer: {
        ...
        documentNumber: { type: String, required: false, index: true, unique: false },
        cuil: { type: String, required: false, index: true, unique: false },
        email: { type: String, required: false, index: false, unique: false },
        phone: { type: String, required: false, index: false, unique: false },
    },
    extractedEntities: [{
...
const InboundEmailModel = mongoose.model(MODEL_NAME, InboundEmailSchema, COLLECTION_NAME);
export { InboundEmailSchema, InboundEmailModel };
