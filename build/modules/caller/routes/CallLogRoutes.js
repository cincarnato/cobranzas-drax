...
async function CallLogFastifyRoutes(fastify, options) {
    const controller = new CallLogController();
    ...
    fastify.get('/api/call-logs/paginate-data-search', { schema: schemas.paginateSchema }, (req, rep) => controller.paginateByDataSearch(req, rep));
    ...
    fastify.post('/api/call-logs/:id/attempts', {
        schema: {
            tags: ['CallLog'],
    ...
    }, (req, rep) => controller.registerAttempt(req, rep));
