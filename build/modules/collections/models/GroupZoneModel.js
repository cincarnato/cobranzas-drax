...
const GroupZoneSchema = new mongoose.Schema({
...
const GroupZoneModel = mongoose.model(MODEL_NAME, GroupZoneSchema, COLLECTION_NAME);
export { GroupZoneSchema, GroupZoneModel };
