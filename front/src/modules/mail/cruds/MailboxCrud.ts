...
class MailboxCrud extends EntityCrud implements IEntityCrud {
  ...
  get headers(): IEntityCrudHeader[] {
    return [
      ...
      {title: 'categories', key: 'categories', align: 'start'},
      {title: 'entities', key: 'entities', align: 'start'},
  ...
  get fields(): IEntityCrudField[] {
    return [
      ...
      },
      {
        ...
        type: 'boolean',
        label: 'attachmentStorageEnabled',
        default: true,
        groupTab: 'Procesamiento'
      },
      {
        name: 'attachmentOcrEnabled',
        type: 'boolean',
      ...
      },
      {
        ...
        type: 'enum',
        label: 'processingProtocol',
        default: 'IMAP',
        groupTab: 'Procesamiento',
        enum: ['IMAP', 'POP']
      },
      {
        name: 'processingIntervalMinutes',
        type: 'number',
        label: 'processingIntervalMinutes',
        default: 5,
        groupTab: 'Procesamiento'
      },
