...
{name:'state',type:'enum',label:'state',default:'PREPARANDO',enum: ['PREPARANDO', 'EN_CURSO', 'ARCHIVADO', 'FINALIZADO', 'VENCIDO']},
{name:'total',type:'number',label:'total',default:0},
{name:'attempts',type:'number',label:'attempts',default:0},
{name:'attemptsControl',type:'array.object',label:'attemptsControl',default:[],objectFields: [{name:'number',type:'number',label:'number',default:0},
