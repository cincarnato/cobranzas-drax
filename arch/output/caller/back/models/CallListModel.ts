...
const CallListSchema = new mongoose.Schema<ICallList>({
            group: {type: mongoose.Schema.Types.ObjectId, ref: 'Group',  required: false, index: false, unique: false },
        ...
        url: {type: String ,  required: false, index: false, unique: false },
            ...
            state: {type: String,  enum: ['PREPARANDO', 'EN_CURSO', 'ARCHIVADO', 'FINALIZADO', 'VENCIDO'], required: false, index: false, unique: false },
