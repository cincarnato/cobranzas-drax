...
const CovenantSchema = new mongoose.Schema<ICovenant>({
            ...
            group: {type: mongoose.Schema.Types.ObjectId, ref: 'Group',  required: true, index: false, unique: false },
            createdBy: {type: mongoose.Schema.Types.ObjectId, ref: 'User',  required: true, index: false, unique: false },
            updatedBy: {type: mongoose.Schema.Types.ObjectId, ref: 'User',  required: true, index: false, unique: false },
