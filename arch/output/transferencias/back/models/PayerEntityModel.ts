...
import type {IPayerEntity} from '../interfaces/IPayerEntity'

const PayerEntitySchema = new mongoose.Schema<IPayerEntity>({
...
const PayerEntityModel = mongoose.model<IPayerEntity, PaginateModel<IPayerEntity>>(MODEL_NAME, PayerEntitySchema,COLLECTION_NAME);
